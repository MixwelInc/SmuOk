...
declare @do_report bigint;          
 ...
 , null [6], null [7], null [8], null [9], null [10], m.M15Num [11], m.M15Name [12], m.M15Date [13], m.M15Qty [14], m.M15Price [15], m.M15Qty * m.M15Price [16], sf.SFRemovedPos [17]
   from SpecVer sv        
 ...
 where svspec = '+CAST(@spec as varchar(max))+'         
  ...
  select          
   sf.SFID [-7], sff.SFSpecList [-6],sfe.SFEId [-5],EName [-4], nvw.bfnum [-3], nvw.smrnum [-2],sf.SFSupplyPID [-1],sf.[Чьи материалы] [0], sf.SFNo+''.''+sf.SFNo2 [1],sf.SFName [2],sf.SFMark [3],sf.SFUnit [4],SFEQty [5], sumks [6], null [7], null [8], nul
l [9], DSumQty [10],  
   m.M15Num [11], m.M15Name [12], m.M15Date [13], m.M15Qty [14], m.M15Price [15], m.M15Qty * m.M15Price [16], sf.SFRemovedPos [17],
